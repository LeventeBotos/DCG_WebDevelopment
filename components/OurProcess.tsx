...
const OurProcess = () => {
  return (
    <section className="px-2 md:px-4">
      <motion.div
        className="border bg-gradient-to-r from-dcg-lightBlue to-dcg-lightGreen text-white rounded-3xl p-8 lg:p-12"
          ...
          {[
            ...
            >
              <div className="relative mb-6">
                <div className="w-16 h-16 border bg-white text-black rounded-lg flex items-center justify-center mx-auto shadow-lg  transition-colors duration-300">
